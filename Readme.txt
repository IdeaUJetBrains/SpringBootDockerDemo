Get the example project: https://github.com/IdeaUJetBrains/SpringBootDockerDemo/
   Created via SpringBootIntialisr.

======================================================================
(1) RUN the APPLICATION locally with the Database from the docker container
======================================================================
1.1 Create a container with DB:
    - run docker-compose-db.yml
1.2. Correct the DB connection url:
...
======================================================================
(2) RUN the APPLICATION in a container with the Database from the docker container
======================================================================

2.1. Correct the DB connection url:
   - go to \resources\application.properties
   - set spring.datasource.url=jdbc:mysql://db:3306/DOCKERDB
2.2. Run docker-compose.yml
2.3. Check that application and DB are running:
